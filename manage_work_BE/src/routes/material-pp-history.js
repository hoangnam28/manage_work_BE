  ...
  try {
    ...
    const result = await connection.execute(
      ...
      )`,
      {
        ...
        glassStyle: data?.glass_style || null,
        resinPercentage: data?.resin_percentage || null,
        ravThickness: data?.rav_thickness || null,
        preferenceClass: data?.preference_class || null,
        useType: data?.use_type || null,
        ppType: data?.pp_type || null,
        tgMin: data?.tg_min || null,
        tgMax: data?.tg_max || null,
