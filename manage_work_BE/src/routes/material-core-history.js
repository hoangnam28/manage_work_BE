  ...
  try {
    ...
    const result = await connection.execute(
      ...
      )`,
      {
        ...
        spec_thickness: data?.spec_thickness || null,
        preference_class: data?.preference_class || null,
        use_type: data?.use_type || null,
        rigid: data?.rigid || null,
        top_foil_cu_weight: data?.top_foil_cu_weight || null,
        bot_foil_cu_weight: data?.bot_foil_cu_weight || null,
        tg_min: data?.tg_min || null,
        tg_max: data?.tg_max || null,
        center_glass: data?.center_glass || null,
        dk_01g: data?.dk_01g || null,
        df_01g: data?.df_01g || null,
        dk_0_001ghz: data?.dk_0_001ghz || null,
        df_0_001ghz: data?.df_0_001ghz || null,
        dk_0_01ghz: data?.dk_0_01ghz || null,
        df_0_01ghz: data?.df_0_01ghz || null,
        dk_0_02ghz: data?.dk_0_02ghz || null,
        df_0_02ghz: data?.df_0_02ghz || null,
        dk_2ghz: data?.dk_2ghz || null,
        df_2ghz: data?.df_2ghz || null,
        dk_2_45ghz: data?.dk_2_45ghz || null,
        df_2_45ghz: data?.df_2_45ghz || null,
        dk_3ghz: data?.dk_3ghz || null,
        df_3ghz: data?.df_3ghz || null,
        dk_4ghz: data?.dk_4ghz || null,
        df_4ghz: data?.df_4ghz || null,
        dk_5ghz: data?.dk_5ghz || null,
        df_5ghz: data?.df_5ghz || null,
        dk_6ghz: data?.dk_6ghz || null,
        df_6ghz: data?.df_6ghz || null,
        dk_7ghz: data?.dk_7ghz || null,
        df_7ghz: data?.df_7ghz || null,
        dk_8ghz: data?.dk_8ghz || null,
        df_8ghz: data?.df_8ghz || null,
        dk_9ghz: data?.dk_9ghz || null,
        df_9ghz: data?.df_9ghz || null,
        dk_10ghz: data?.dk_10ghz || null,
        df_10ghz: data?.df_10ghz || null,
        dk_15ghz: data?.dk_15ghz || null,
        df_15ghz: data?.df_15ghz || null,
        dk_16ghz: data?.dk_16ghz || null,
        df_16ghz: data?.df_16ghz || null,
        dk_20ghz: data?.dk_20ghz || null,
        df_20ghz: data?.df_20ghz || null,
        dk_25ghz: data?.dk_25ghz || null,
        df_25ghz: data?.df_25ghz || null,
        dk_30ghz: data?.dk_30ghz || null,
        df_30ghz: data?.df_30ghz || null,
        dk_35ghz: data?.dk_35ghz || null,
        df_35ghz: data?.df_35ghz || null,
        dk_40ghz: data?.dk_40ghz || null,
        df_40ghz: data?.df_40ghz || null,
        dk_45ghz: data?.dk_45ghz || null,
        df_45ghz: data?.df_45ghz || null,
        dk_50ghz: data?.dk_50ghz || null,
        df_50ghz: data?.df_50ghz || null,
        dk_55ghz: data?.dk_55ghz || null,
